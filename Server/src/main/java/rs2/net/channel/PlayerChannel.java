package rs2.net.channel;

import rs2.Server;
import rs2.game.model.World;
import rs2.game.model.entity.mob.player.Player;
import rs2.game.model.entity.mob.player.io.PlayerDeserializer;
import rs2.net.packet.Sendable;
import io.netty.channel.Channel;
import io.netty.channel.ChannelFuture;
import io.netty.channel.ChannelFutureListener;
import rs2.net.NetworkConstants;
import rs2.net.codec.game.GamePacketDecoder;
import rs2.net.codec.game.GamePacketEncoder;
import rs2.net.codec.login.LoginDetailsPacket;
import rs2.net.codec.login.LoginResponse;
import rs2.net.codec.login.LoginResponsePacket;
